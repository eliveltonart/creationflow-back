...
// Cria o transporter uma única vez e reutiliza para todos os envios
...
/**
 * Envia um email usando as configurações SMTP das variáveis de ambiente.
 * Retorna true se enviado com sucesso, false se falhou ou SMTP não configurado.
 */
...
/**
 * Envia email de convite para um membro.
 */
